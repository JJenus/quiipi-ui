  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="relative">
        ...
        <Input
          placeholder={isMobile ? "Search projects..." : "Search projects by name or client..."}
          value={search}
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-lg font-medium text-center">No projects found</p>
